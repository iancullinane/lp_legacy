...
<body>
	...
	<h3>{$fullname} has contacted lpcommercialcleaning.com"</h3>
	...
	<tr>
		...
		<table id="titlerow" width="100%" border="1" align="left">
			<tr>
				<td>Name</td>
				<td>{$fullname}</td>
			</tr>
		...
		<!--
		<img class="image_fix" src="../assets/logo/brand_name.png" alt="Your alt text" title="Your title text" width="x" height="x" />
		-->
